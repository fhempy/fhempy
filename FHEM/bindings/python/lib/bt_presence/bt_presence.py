...
class bt_presence:
        ...
        while True:
            ...
            try:
                ...
                if device_name:
                    ...
                    if curr_rssi != rssi:
                        curr_rssi = rssi
                        await fhem.readingsSingleUpdateIfChanged(self.hash, "rssi", rssi, 1)
                    new_state = "present"
            except:
    ...
    async def Define(self, hash, args, argsh):
        ...
        await fhem.addToDevAttrList(hash["NAME"], "absentInterval presentInterval absentThreshold presentThreshold")
