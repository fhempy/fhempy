...
class zappi(generic.FhemModule):
    def __init__(self, logger):
        ...
        self.zappi_box = None
        self.harvis = []
        self.harvi_serials = ["1902428", "1901988"]
    ...
    async def Define(self, hash, args, argsh):
        ...
        if len(args) > 5:
            return "Usage: define myZappiBox fhempy zappi serialnumber API_Key"
    ...
    async def setup_connection(self):
            ...
            if self.zappi_box != None:
                ...
                # add harvi serial numbers for every single harvi and provide a loop counter
