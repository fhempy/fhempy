    ...
    def __init__(self, logger):
        ...
        set_config = {
            ...
            "max_compensation_power": {
                ...
                "help": "Maximum compensation power from battery [W]. \n Registry: p_rec_lim[0]",
            ...
            "battmng_kreserve": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Reserve coefficent for battery power management [-] Higher values = lower battery SoC (higher reserve). Decimal values from 0.00 - 2.00 are allowed.\n Registry: bat_mng_struct.k_reserve",
                "function": "set_rct_write",
            ...
            "battmng_ktrust": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Time constant for battery power management [Seconds] Lower values = faster reaction on weather prediction. Decimal values from 0.00 - 1000 are allowed.\n Registry: bat_mng_struct.k_trust",
                "function": "set_rct_write",
            ...
            "batt_soc_min": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Minimum battery SoC target [-]. Decimal values from 0.00 - 1.00 are allowed.\n Registry: power_mng.soc_min",
                "function": "set_rct_write",
            ...
            "batt_soc_max": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery SoC target [-]. Decimal values from 0.00 - 1.00 are allowed.\n Registry: power_mng.soc_max",
                "function": "set_rct_write",
            ...
            "conv_max_current": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery converter current (charge/discharge) [A]. Decimal values from 0.00 - 25.00 are allowed.\n Registry: acc_conv.i_discharge_max",
                "function": "set_rct_write",
            ...
            "conv_max_dischargecurrent": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery discharge current [A]. Decimal values from 0.00 - 25.00 are allowed.\n Registry: acc_conv.i_discharge_max",
                "function": "set_rct_write",
            ...
            "conv_max_chargecurrent": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery charge current [A]. Decimal values from 0.00 - 25.00 are allowed.\n Registry: acc_conv.i_charge_max",
                "function": "set_rct_write",
            ...
            "max_power_ac": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum inverter AC power [W]. Decimal values from 0 - 10000 are allowed.\n Registry: p_rec_lim[2]",
                "function": "set_rct_write",
            ...
            "min_soc_maint_charge": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Min SoC for start maintenance charging [-]. Decimal values from 0.00 - 1.00 are allowed. \n Registry: power_mng.soc_charge",
                "function": "set_rct_write",
            ...
            "plant_power_reduction": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Regulatory power limitation of plant. Germany=0.7 [-]. Decimal values from 0.00 - 1.00 are allowed.\n Registry: buf_v_control.power_reduction",
                "function": "set_rct_write",
            ...
            "max_power_batt2grid": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Battery power to grid limitation [W] (normally 0).\n Registry: p_rec_lim[1]",
                "options": "slider,0,1,10000",
                "function": "set_rct_write",
