    ...
    def __init__(self, logger):
        ...
        set_config = {
            ...
            "batt_soc_min": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Minimum battery SoC target [-] power_mng.soc_min. Decimal values from 0.00 - 1.00 are allowed.",
                "function": "set_rct_write",
            ...
            "batt_soc_max": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery SoC target [-] power_mng.soc_max. Decimal values from 0.00 - 1.00 are allowed.",
                "function": "set_rct_write",
            ...
            "conv_max_current": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery converter current (charge/discharge) [A] acc_conv.i_discharge_max. Decimal values from 0.00 - 25.00 are allowed.",
                "function": "set_rct_write",
            ...
            "conv_max_dischargecurrent": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery discharge current [A] acc_conv.i_discharge_max. Decimal values from 0.00 - 25.00 are allowed.",
                "function": "set_rct_write",
            ...
            "conv_max_chargecurrent": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum battery charge current [A] acc_conv.i_charge_max. Decimal values from 0.00 - 25.00 are allowed.",
                "function": "set_rct_write",
            ...
            "max_power_ac": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Maximum inverter AC power [W] p_rec_lim[2]. Decimal values from 0 - 10000 are allowed.",
                "function": "set_rct_write",
            ...
            "min_soc_maint_charge": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Min SoC for start maintenance charging [-] power_mng.soc_charge Decimal values from 0.00 - 1.00 are allowed.",
                "function": "set_rct_write",
            ...
            "plant_power_reduction": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Regulatory power limitation of plant. Germany=0.7 [-] buf_v_control.power_reduction. Decimal values from 0.00 - 1.00 are allowed.",
                "function": "set_rct_write",
            ...
            "max_power_batt2grid": {
                "args": ["value"],
                "params": {"value": {"format": "float"}},
                "help": "Battery power to grid limitation [W] power_mng.soc_charge (normally 0). Decimal values from 0.00 - 10000 are allowed.",
                "function": "set_rct_write",
