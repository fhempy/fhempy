...
* fix(tuya_smartlife): Fix for TypeError: 'DeviceFunction' object is not subscriptable' (#465) ([`65c5fae`](https://github.com/fhempy/fhempy/commit/65c5faebae40c329f2b6723d9f6beaac2c54acc5))

* fix(zigbee2mqtt): revert last commits ([`38e3558`](https://github.com/fhempy/fhempy/commit/38e35584c21a71eef9791b0770c16a48b1ec29ce))

* fix(zigbee2mqtt): fix nodejs installations with nvm ([`4c1858a`](https://github.com/fhempy/fhempy/commit/4c1858aee136cda810274609059d12d1f78f2e3f))

* fix(zigbee2mqtt): support nvm installations ([`2f3d17a`](https://github.com/fhempy/fhempy/commit/2f3d17a5eac0d8500942a3c68a1cf536d29e16a8))

* fix(huawei_modbus): add 60s sleep before reconnect ([`1890639`](https://github.com/fhempy/fhempy/commit/18906394cfc8f38487f0b1b6d6383baa26a11df9))

### Chores

* chore(deps-dev): bump goodwe from 0.4.0 to 0.4.8 (#450) ([`238b382`](https://github.com/fhempy/fhempy/commit/238b382543267e4d80881e183f86a8e106df92be))

* chore(deps): bump shogo82148/actions-setup-perl from 1.30.0 to 1.31.3 (#457) ([`d4d078c`](https://github.com/fhempy/fhempy/commit/d4d078cb35f0dcebfecac236a8050bc591353a32))

* chore(deps): bump python-semantic-release/python-semantic-release (#462)

Bumps [python-semantic-release/python-semantic-release](https://github.com/python-semantic-release/python-semantic-release) from 9.8.5 to 9.12.0.
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`f30049d`](https://github.com/fhempy/fhempy/commit/f30049dabfd590e5bc2dbca5a72a91a0b6489e2c))

* chore(deps-dev): bump btsocket from 0.2.0 to 0.3.0 (#447) ([`e8eeab2`](https://github.com/fhempy/fhempy/commit/e8eeab2b5cc6661d8f0f0a4ce88f9e9e5febfb62))

* chore(deps): bump python-semantic-release/python-semantic-release (#444) ([`c953566`](https://github.com/fhempy/fhempy/commit/c95356630e2a448a2c72e89ba42bf708f042999a))

* chore(deps): bump shogo82148/actions-setup-perl from 1.29.0 to 1.30.0 (#436) ([`a990dd2`](https://github.com/fhempy/fhempy/commit/a990dd2ea5d16cb038cb4f94f6d7c4f63699474a))

* chore(deps): bump requests from 2.31.0 to 2.32.2 (#443) ([`fd1c86e`](https://github.com/fhempy/fhempy/commit/fd1c86eaa39e77dac92d04c8ca2f1a870b9632c6))

* chore(deps): bump urllib3 from 2.2.1 to 2.2.2 (#437) ([`9195575`](https://github.com/fhempy/fhempy/commit/9195575e8f957efae1d5948682cbf5cd12ae121d))

* chore(deps): bump certifi from 2024.2.2 to 2024.7.4 (#438) ([`c34bdb6`](https://github.com/fhempy/fhempy/commit/c34bdb6dd268a7e355692bb9600952bd283bc3c7))

* chore(deps): bump zipp from 3.18.1 to 3.19.1 (#440) ([`ec35a43`](https://github.com/fhempy/fhempy/commit/ec35a43044b39f797a575d1792dc22190dc776ba))

* chore(deps-dev): bump pytest from 8.1.1 to 8.2.2 (#442) ([`43c9f27`](https://github.com/fhempy/fhempy/commit/43c9f27fd8ca4372aaaef4de8664c9ed65ab28e7))

* chore(deps-dev): bump tox from 4.14.2 to 4.15.1 (#435) ([`25dccd1`](https://github.com/fhempy/fhempy/commit/25dccd1dd017428be357f76e332732186d151146))

* chore(deps-dev): bump tqdm from 4.66.2 to 4.66.3 (#420) ([`1031c0c`](https://github.com/fhempy/fhempy/commit/1031c0c714bc974b0feffe8077218ce041e6cd4c))

* chore(deps-dev): bump setuptools from 69.5.1 to 70.0.0 (#441) ([`b64f2d0`](https://github.com/fhempy/fhempy/commit/b64f2d0377d00f0d13b208279d246b553d77650c))

### Features

* feat(pyit600): reading for current_humidity added (#458)

* Add reading current humidity

* Update README.md

Add SQ610RF to supported devices ([`ae91811`](https://github.com/fhempy/fhempy/commit/ae918117784d995c4cd46b131746545cb898a910))
...
* fix(fusionsolar): fix multiregion accounts ([`256e464`](https://github.com/fhempy/fhempy/commit/256e464d135f88f7304a1f80e52a338b0b99cd09))
